...
doctors_dataset = _base_dir + "JMetal/doctor_dataset.csv"
testing = _base_dir + "FinalWeights/testing.csv"
training_data_whole = _base_dir + "FinalWeights/training_data_whole.csv"
cross_validation_whole = _base_dir + "FinalWeights/cross_validation_data_whole.csv"
